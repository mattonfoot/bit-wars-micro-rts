...
export const BLUE_LESSONS = {
  ...
  chapters: [
    ...
    },
    {
      ...
      // The three target rigs stand on the veins between the bases (the centre pair and the Foundry's forward vein), never inside the bunkered base, so a raid can reach them and leave.
      enemy: war('red', 'easy', { incomeMult: 0.65, aiPop: 16, points: [3, 4, 5], structures: [{ key: 'drill', at: 'ore:2' }, { key: 'drill', at: 'ore:4' }, { key: 'drill', at: 'ore:5' }, { key: 'bunker', at: [-3, 3] }, { key: 'works', at: [4, -2] }], squads: [{ key: 'bolts', at: [0, 5] }] }),
      stages: [
      ...
      hints: [{ at: 'start', text: 'The Foundry here is alive and will attack. Claim points early and keep a Thorn and some Darts at home.' }, { at: 'stage:1', text: 'The rigs stand on the veins between the bases, not inside the Foundry walls. Kites burn structures fast but are vehicles with thin frames: rifles do a third damage, yet a few squads together still bring a wing down, and gun teams and mortars do it faster. Hit a rig, then fly home before the response arrives.' }],
    },
    {
