...
export const THEMES = {
  verdant: {
    ...
    decor: 'trees',
    ink: { water: '#3b8bff', shallow: 'rgba(120,180,255,0.7)', brush: '#3fbf5a' },
  },
  ashfall: {
    ...
    decor: 'embers',
    ink: { water: '#ff6a1f', deep: 'rgba(255,106,31,0.35)', shallow: 'rgba(255,140,60,0.7)', brush: '#8a6a3a', mountain: 'rgba(230,220,210,0.85)' },
  },
  frost: {
    ...
    colors: { ground: ['#d9e3ea', '#e2eaf0', '#cfdbe4', '#e8eef3'], road: '#b7c3cc', water: '#5f93c4', waterDeep: '#3b6b9b', shallow: '#a9d2ec', mountain: '#8e98a3', mountainLight: '#f3f7fa', mountainDark: '#5a636c', brush: '#5a7a68', brushDot: '#2f5540', rock: '#8a949c', rockDark: '#525a62', wall: '#9aa5ad', ruin: '#7c858d', ruinDark: '#4e565c', crater: '#b8c6d0', rubble: '#9ea9b1', ore: '#7fe3ff', oreDark: '#2f7fa0', fog: '#000000' },
    decor: 'pines',
    ink: { water: '#a9d2ec', deep: 'rgba(169,210,236,0.35)', shallow: 'rgba(220,240,255,0.7)', brush: '#4f9a7a', mountain: 'rgba(255,255,255,0.9)' },
  },
  urban: {
  ...
  crystal: {
    ...
    colors: { ground: ['#c9a86a', '#d1b074', '#c2a061', '#d8b87e'], road: '#b39258', water: '#3aa3a8', waterDeep: '#25767b', shallow: '#8ec9c8', mountain: '#9c6f3f', mountainLight: '#d7a26b', mountainDark: '#5c3f21', brush: '#8a9a52', brushDot: '#5c7a2e', rock: '#8fd3f4', rockDark: '#3d8fb8', wall: '#b08e5a', ruin: '#a2814f', ruinDark: '#5e4a2b', crater: '#a98a54', rubble: '#b7a074', ore: '#ff5fd2', oreDark: '#8e2a75', fog: '#000000' },
    decor: 'crystals',
    ink: { water: '#3aa3a8', deep: 'rgba(58,163,168,0.35)', shallow: 'rgba(142,201,200,0.7)', brush: '#9ab04a', mountain: 'rgba(240,225,200,0.85)', rock: '#8fe3ea' },
  },
};
