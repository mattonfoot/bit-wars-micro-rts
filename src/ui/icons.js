...
// carapace (broad shoulders tapering to a point, an inverted triangle with plated segments), the Foundry a hammer (a chunky head with chamfered left corners and a flared right face, on a thin shaft with three wraps of binding at the grip),
...
const EMBLEMS = {
  ...
  red: 'M5.6 2H21l-2.6 7H5.6L4 7.4V3.6zM10.7 9h2.6v6.3h-2.6zM10.1 16.3l3.8-1.3v1.4l-3.8 1.3zM10.1 18.8l3.8-1.3v1.4l-3.8 1.3zM10.1 21.3l3.8-1.3v1.4l-3.8 1.3z',
